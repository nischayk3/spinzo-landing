export const SERVICE_LOCATIONS = [
  ...
  },
  {
    slug: 'harlur',
    name: 'Harlur',
    nearby: ['Harlur Main Road', 'Harlur Lake Area', 'Harlur Layout', 'Junnasandra', 'Kudlu Gate'],
    keywords: ['laundry service Harlur', 'laundry pickup Harlur', 'wash and fold Harlur', 'laundry in Harlur']
  },
  {
    slug: 'begur',
    name: 'Begur',
    nearby: ['Begur Main Road', 'Begur Hobli', 'Gottigere', 'Nyanappanahalli', 'Chikkanahalli'],
    keywords: ['laundry service Begur', 'laundry pickup Begur', 'laundry in Begur', 'wash and fold Begur']
  },
  {
    slug: 'sarjapur-road',
    name: 'Sarjapur Road',
    nearby: ['Sarjapur Junction', 'Carmelaram', 'Devarabisanahalli', 'Kodathi', 'Belandur'],
    keywords: ['laundry service Sarjapur Road', 'laundry near Sarjapur Road', 'wash and fold Sarjapur', 'laundry in Sarjapur']
  },
  {
    slug: 'electronic-city',
    name: 'Electronic City',
    nearby: ['Electronic City Phase 1', 'Electronic City Phase 2', 'Neeladri Road', 'Konappana Agrahara', 'Bommasandra'],
    keywords: ['laundry service Electronic City', 'laundry near Electronic City', 'wash and fold Electronics City', 'laundry in Electronic City']
  },
  {
    slug: 'bellandur',
    name: 'Bellandur',
    nearby: ['Bellandur Outer Ring Road', 'Bellandur Lake Area', 'HSR Layout', 'Marathahalli Bridge', 'Iblur Village'],
    keywords: ['laundry service Bellandur', 'laundry near Bellandur', 'wash and fold Bellandur', 'laundry in Bellandur']
  },
];
