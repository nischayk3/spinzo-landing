...
const PHONE_NUMBER = "917676878832";
...
export const WhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#994BFF] rounded-full flex items-center justify-center shadow-lg hover:bg-[#8828FF] hover:scale-105 active:scale-95 transition-all duration-300 group"
