      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="md:col-span-8 lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="/locations/wilson-garden" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Wilson Garden</a></li>
                <li><a href="/locations/shanti-nagar" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Shanti Nagar</a></li>
                <li><a href="/locations/adugodi" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Adugodi</a></li>
                <li><a href="/locations/bommanahalli" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Bommanahalli</a></li>
                <li><a href="/service-areas" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors font-semibold">View All →</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-zinc-900 mb-4 uppercase tracking-wider">Company</h4>
              <ul className="space-y-3">
                <li><a href="https://spinzo.in/" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Web App</a></li>
                <li><a href="https://play.google.com/store/apps/details?id=com.nischayk3.Spinit" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Android App</a></li>
                <li><a href="https://apps.apple.com/in/app/spinzo-get-laundry-in-hours/id6758751814" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">iOS App</a></li>
                <li><a href="/" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Privacy Policy</a></li>
                <li><a href="/" className="text-sm text-zinc-600 hover:text-[#994BFF] transition-colors">Terms of Service</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-zinc-200/60 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <a href="https://spinzo.in/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-zinc-600 hover:bg-[#994BFF]/10 hover:text-[#994BFF] shadow-sm transition-all duration-300">
