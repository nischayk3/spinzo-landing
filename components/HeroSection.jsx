...
export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-fit md:min-h-screen flex items-start md:items-center overflow-hidden bg-white pt-8 pb-16 md:pt-0 md:pb-0"
    >
      {/* Soft background glows */}
      <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-purple-100/40 rounded-full filter blur-3xl opacity-50 animate-blob pointer-events-none" />
      <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-purple-100/40 rounded-full filter blur-3xl opacity-50 animate-blob animation-delay-2000 pointer-events-none" />
          ...
          <div className="text-center lg:text-left">
            <motion.div {...fadeUp}>
              <span className="inline-flex items-center gap-2 rounded-full bg-white/80 shadow-md shadow-purple-500/20 px-4 py-1.5 text-sm font-semibold text-zinc-900 mb-6">
                <span className="w-2.5 h-2.5 rounded-full bg-[#994BFF] animate-pulse" />
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tighter leading-tight text-[#1F0B3F] mb-6 font-display"
            >
              Laundry Pickup in <span className="text-[#994BFF]">30 Mins.</span>
              <br />
              Fresh Clothes in <span className="text-[#994BFF]">6 Hours.</span>
            </motion.h1>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-5 md:p-6 shadow-lg shadow-purple-500/5 border border-purple-100/50 mb-6"
            >
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4">
                ...
                >
                  <Globe size={16} className="text-[#994BFF]" />
                  Use Web App
                </a>
              </div>
            </motion.div>
            ...
            >
              {trustItems.map((item) => (
                <div key={item.label} className="flex items-center gap-2.5 text-sm font-medium text-black">
                  <item.icon size={18} className="text-[#994BFF]" />
                  {item.label}
                </div>
              ))}
            </motion.div>
